...
/**
 * Executes a pipeline of word rules against a given list of words. Each rule is applied
 * independently and results are collected into a Result.
 */
