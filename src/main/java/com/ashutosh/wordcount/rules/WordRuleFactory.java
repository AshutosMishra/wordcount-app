...
/**
 * Factory that maps a RuleType to its corresponding cached WordRule implementation.
 * Rules are stateless singletons — safe to share across calls.
 */
public class WordRuleFactory {
	 ...
	 */
	private static final Map<RuleType, WordRule<?>> CACHE = Map.of(RuleType.STARTS_WITH_M, new StartsWithMRule(),
			RuleType.LENGTH_GREATER_THAN_FIVE, new LengthGreaterThanFiveRule());
